    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Directory dir = FSDirectory.open(indexPath);
            ...
            if (leafReader instanceof CodecReader) {
                codecReader = (CodecReader) leafReader;
            } else {
                throw new Error("Expected a CodecReader from force-merged index");
            }
            CodecReader reordered = reorderer.reorder(codecReader, reorderedDir, ForkJoinPool.commonPool());
