...
engine = sys.argv[1]
idx_path = 'idx'
binary = './target/release/do_query'

proc = subprocess.Popen([binary, idx_path],
    stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE,
    cwd='/Users/medcl/rust/search-benchmark-game/engines/' + engine)
...
print("Waiting for {} to load...".format(engine), flush=True)
time.sleep(35)
